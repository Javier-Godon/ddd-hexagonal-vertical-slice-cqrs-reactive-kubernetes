...
import es.bluesolution.pokedex.usecases.getpokemondetailsbyid.rest.TypeResponse;
import io.swagger.v3.oas.annotations.media.ArraySchema;
import io.swagger.v3.oas.annotations.media.Schema;
import java.util.List;

public interface DetailedPokemonResponseSpec {
  ...
  @ArraySchema(schema = @Schema(implementation = TypeResponse.class))
